...
def generate_image(prompt):
    ...
    try:
        ...
        if 'logo' in clean_prompt.lower():
            clean_prompt += ", professional logo design, vector style, clean, bold typography, centered text, high contrast"
        elif 'icon' in clean_prompt.lower():
            clean_prompt += ", modern icon design, minimalist, flat design"
        else:
        ...
        if any(word in clean_prompt.lower() for word in ['logo', 'name', 'text', 'brand']):
            clean_prompt += ", clear readable text, typography centered, bold letters"
        
        encoded_prompt = urllib.parse.quote(clean_prompt)
        # Use Pollinations.ai with better parameters for text
