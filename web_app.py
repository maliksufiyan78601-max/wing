...
def is_image_generation_request(text):
    keywords = ['generate image', 'create image', 'make image', 'draw', 'picture', 'photo', 'image of', 'picture of']
...
def generate_image(prompt):
    ...
    try:
        ...
        clean_prompt = prompt.replace("generate image of", "").replace("create image of", "").replace("draw a", "").replace("make a", "").strip()
...
if prompt := st.chat_input("Type your message..."):
    ...
    if is_image_generation_request(prompt):
        with st.chat_message("assistant"):
            # Generate image URL and fetch data immediately (no intermediate message)
